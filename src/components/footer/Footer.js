      ...
      <footer className="bg-gray-800 text-white">
        <Box className="grid grid-col-2 lg:grid-flow-col md:grid-flow-row px-4 py-8 mx-2">
          <Box className="lg:w-3/5 p-4">
            ...
            <Box class="mt-6 lg:mb-0 mb-6 flex">
              <svg
                className="bg-gray-50 text-lightBlue-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2"
              ...
              <svg
                className="bg-gray-50 text-lightBlue-400 shadow-lg font-normal h-10 w-11 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
              >
